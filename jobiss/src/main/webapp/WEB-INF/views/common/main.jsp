...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		<h1 id="logo" class="text-center">
			...
			<span class="tagline">취업 정보 자비즈~<br>
...
<main id="main">
	...
	<div class="container">
		...
		<div class="row section recentworks topspace">
			...
			<h2 class="section-title"><span>BEST 자기소개서</span></h2>
			
			<div id="imageSlider" class="carousel slide" data-ride="carousel" data-interval="false" data-touch="true">
				<!-- Wrapper for slides -->
