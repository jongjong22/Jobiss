	...
	<div class="mycommunity_big">
		...
		<c:choose>
			...
			<table border="1" align="center">
				<h1 align="center">내가 쓴 Community</h1>
				<tr>
					<th>이메일</th>
					<th>제목</th>
					<th>내용</th>
			...
			<div class="page" align="center">
				<c:if test="${startPage > 10 }">
					<a href="mycommunity.do?page=${pageNum}.do?page=${startPage+1 }">이전</a>
				</c:if>
				<c:forEach begin="${startPage}" end="${endPage}" var="pageNum">
					<a href="mycommunity.do?page=${pageNum}">${pageNum }</a>
				</c:forEach>
				<c:if test="${endPage < pageCount}">
					<a href="mycommunity.do?page=${pageNum}.do?page=${endPage + 1}">다음</a>
				</c:if>
			</div>
			</c:when>
			<c:otherwise>
				<h1 align="center">Community 글이 없습니다.</h1>
			</c:otherwise>
			</c:choose>
</body>
</html>