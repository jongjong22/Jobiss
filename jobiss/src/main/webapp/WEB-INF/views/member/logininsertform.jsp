		...
		<table border=1 width="500" align="center">
			...
			<tr>
				...
				<td colspan="2"><input type="text" id="memail" name="memail"
					required placeholder="아이디를 입력하세요."> <button type="button" onclick="idcheck()">중복체크</button>
			...
			<tr>
				...
				<td colspan="2"><input type="text" id="mname" name="mname"
					required placeholder="이름을 입력하세요."></td>
			</tr>
			<tr>
				<td>전화번호</td>
				<td colspan="2"><input type="tel" id="mphone" name="mphone"
					maxlength="11" required placeholder="-빼고 번호 입력하세요."></td>
			</tr>
			<tr>
				<td>나이</td>
				<td colspan="2"><input type="text" id="mage" name="mage"
					maxlength="2" required placeholder="나이를 입력하세요."></td>
			</tr>
			<tr>
				<td>성별</td>
				<td colspan="2">남<input type="radio" id="male" name="mgender"
			...
			<tr>
				...
				<td colspan="2"><input type="text" id="maddress"
					name="maddress" required placeholder="주소를 입력하세요."><button type="button" onclick="sample6_execDaumPostcode()">주소검색</button></td>
					
			</tr>
			<tr>
				<td>경력</td>
				<td colspan="2"><input type="text" id="mcareer" name="mcareer"
					required placeholder="경력을 입력하세요."></td>
			</tr>
			<tr>
				<td>학교</td>
				<td colspan="2"><input type="text" id="mschoolname"
					name="mschoolname" required placeholder="학교 이름 입력하세요."></td>
			</tr>
			<tr>
			<td>전공 및 학력</td>
			<td><input type="text" id="mschoolmajor" name="mschoolmajor"
					required placeholder="전공을 입력하세요."> <select name="mschooltype" id="mschooltype">
			...
			<tr>
				...
				<td><input type="date" id="mschoolstartreg"
					name="mschoolstartreg"><input type="date" id="mschoolendreg"
					name="mschoolendreg"></td>
			</tr>
			<td>희망직종</td>
			<td colspan="2"><input type="text" id="mjobtype" name="mjobtype" required
